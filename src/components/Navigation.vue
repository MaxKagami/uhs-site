    ...
    <b-navbar toggleable="sm" type="light" variant="light">
     <b-container>
      ...
      <div class="flex-column">
        <b-navbar-nav>
          <b-nav-item>{{ $contacts.main.telephone }}</b-nav-item>
          <b-nav-item>{{ $contacts.main.email }}</b-nav-item>
        </b-navbar-nav>
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav class="mr-auto">
            <b-nav-item to="/about">{{ $about.name }}</b-nav-item>
            <b-nav-item-dropdown  to="/services" text="Услуги" right>
              <b-dropdown-item>Для физических лиц</b-dropdown-item>
            ...
            <b-nav-item to="/vacancies">Вакансии</b-nav-item>
